...
namespace BookShop_CNPM.BUS
{
    public class ImportChangeBillBUS : IBUS<ImportChangeBillDTO>
    {
        ...
        public List<ImportChangeBillDetailDTO> getImportChangeBillDetailList(string id)
        {
            return ImportChangeBillDAO.Instance.getImportChangeBillDetailList(id);
        }

        public bool createImportChangeBillDetail(ImportChangeBillDetailDTO customerChangeBillDetail)
        {
            return ImportChangeBillDAO.Instance.createImportChangeBillDetail(customerChangeBillDetail);
        }
    }
}
