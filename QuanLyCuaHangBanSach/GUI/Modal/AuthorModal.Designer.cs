...
namespace QuanLyCuaHangBanSach.GUI.Modal
{
    partial class AuthorModal
    {
        ...
        private void InitializeComponent()
        {
			...
			this.genderCbx.KeyDown += new System.Windows.Forms.KeyEventHandler(this.AuthorModal_KeyDown);
			...
			this.birthYear.KeyDown += new System.Windows.Forms.KeyEventHandler(this.AuthorModal_KeyDown);
			...
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.AuthorModal_KeyDown);
