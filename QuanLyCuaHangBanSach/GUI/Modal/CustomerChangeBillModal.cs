...
namespace QuanLyCuaHangBanSach.GUI.Modal
{
    public partial class CustomerChangeBillModal : Form
    {
        ...
        {
            /*using (AddBookToCustomerChangeBillModal addBookToBillModal = new AddBookToCustomerChangeBillModal(customerChangeBillDetailList))
            {
                addBookToBillModal.ShowDialog();


                foreach (CustomerChangeBillDetailDTO customerChangeBillDetail in addBookToBillModal.selectedCustomerChangeBillDetailList)
                {
                ...
                this.loadCustomerChangeBillDetailList();
            }*/
        }
