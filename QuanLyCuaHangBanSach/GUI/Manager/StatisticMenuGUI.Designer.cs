...
{
    partial class StatisticMenuGUI
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(StatisticMenuGUI));
			this.panel1 = new System.Windows.Forms.Panel();
			this.tableLayoutPanel1 = new System.Windows.Forms.TableLayoutPanel();
			this.CustomerPanel = new Guna.UI.WinForms.GunaGradient2Panel();
			this.panel7 = new System.Windows.Forms.Panel();
			this.label5 = new System.Windows.Forms.Label();
			this.guna2PictureBox4 = new Guna.UI2.WinForms.Guna2PictureBox();
			this.ProductPanel = new Guna.UI.WinForms.GunaGradient2Panel();
			this.panel4 = new System.Windows.Forms.Panel();
			this.label4 = new System.Windows.Forms.Label();
			this.guna2PictureBox3 = new Guna.UI2.WinForms.Guna2PictureBox();
			this.RevenuePanel = new Guna.UI.WinForms.GunaGradient2Panel();
			this.panel6 = new System.Windows.Forms.Panel();
			this.label3 = new System.Windows.Forms.Label();
			this.guna2PictureBox2 = new Guna.UI2.WinForms.Guna2PictureBox();
			this.StaffPanel = new Guna.UI.WinForms.GunaGradient2Panel();
			...
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.tableLayoutPanel1.Controls.Add(this.CustomerPanel, 1, 1);
			this.tableLayoutPanel1.Controls.Add(this.ProductPanel, 0, 0);
			...
			this.CustomerPanel.Controls.Add(this.panel7);
			...
			this.label5.Click += new System.EventHandler(this.CustomerPanel_Click);
			// 
			// guna2PictureBox4
			// 
			...
			this.guna2PictureBox4.Click += new System.EventHandler(this.CustomerPanel_Click);
			// 
			// ProductPanel
			// 
			this.ProductPanel.Anchor = System.Windows.Forms.AnchorStyles.Right;
			...
			this.label4.Click += new System.EventHandler(this.ProductPanel_Click);
			// 
			// guna2PictureBox3
			// 
			...
			this.guna2PictureBox3.Click += new System.EventHandler(this.ProductPanel_Click);
			// 
			// RevenuePanel
			// 
			this.RevenuePanel.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.RevenuePanel.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.RevenuePanel.BackColor = System.Drawing.Color.Transparent;
			this.RevenuePanel.Controls.Add(this.panel6);
			...
			this.label3.Click += new System.EventHandler(this.RevenuePanel_Click);
			// 
			// guna2PictureBox2
			// 
			...
			this.guna2PictureBox2.Click += new System.EventHandler(this.RevenuePanel_Click);
			// 
			// StaffPanel
			// 
			this.StaffPanel.Anchor = System.Windows.Forms.AnchorStyles.Left;
			...
			this.StaffPanel.Controls.Add(this.panel5);
			...
			this.label2.Click += new System.EventHandler(this.StaffPanel_Click);
			// 
			// guna2PictureBox1
			// 
			...
			this.guna2PictureBox1.Click += new System.EventHandler(this.StaffPanel_Click);
			// 
			// panel2
			// 
		...
		private Guna.UI.WinForms.GunaGradient2Panel CustomerPanel;
		private Guna.UI.WinForms.GunaGradient2Panel ProductPanel;
		private Guna.UI.WinForms.GunaGradient2Panel RevenuePanel;
		private Guna.UI.WinForms.GunaGradient2Panel StaffPanel;
