...
{
	partial class ImportRefundBillGUI
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.closeBtn.Location = new System.Drawing.Point(1319, 12);
			...
			this.line1.Location = new System.Drawing.Point(15, 51);
			...
			this.dgvImportRefund.TabIndex = 44;
			...
			this.Name = "ImportRefundBillGUI";
			this.ShowInTaskbar = false;
			this.Text = "ImportRefundBill";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.ImportRefundBillGUI_FormClosed);
			this.Load += new System.EventHandler(this.ImportRefundBillGUI_Load);
